...
function analyzeViolations(chromosome, workers, shifts, periodDates, holidays, requests, requestLookup) {
...
async function main() {
    ...
    for (const item of testConfigs) {
        ...
        for (let run = 1; run <= 10; run++) {
            ...
            const result = (0, geneticAlgorithm_1.runGeneticAlgorithm)(workers, shifts, periodDates, requests, holidays, item.config);
            ...
            console.log(`|  ${String(run).padStart(2, ' ')}   |   ${runData.fitnessScore.toFixed(2).padStart(8, ' ')}    |       ${String(runData.hardViolations).padStart(2, ' ')}        |       ${String(runData.softViolations).padStart(2, ' ')}        |   ${timeFormatted.padStart(10, ' ')}    |`);
        }
        ...
        console.log('|-------|---------------|-----------------|-----------------|-----------------|');
        console.log(`| RATA2 |   ${avgFitness.toFixed(2).padStart(8, ' ')}    |       ${avgHard.toFixed(1).padStart(4, ' ')}      |       ${avgSoft.toFixed(1).padStart(4, ' ')}      |   ${avgTimeFormatted.padStart(10, ' ')}    |`);
        console.log('\n');
    }
    ...
    for (const item of allSummary) {
        ...
        console.log(`| ${label} |      ${avgFitness.toFixed(2).padStart(8, ' ')}     |      ${avgHard.toFixed(1).padStart(4, ' ')}      |      ${avgSoft.toFixed(1).padStart(4, ' ')}      |     ${avgTimeFormatted.padStart(12, ' ')}  |`);
    }
    console.log('========================================================================\n');
